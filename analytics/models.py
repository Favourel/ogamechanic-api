...
class AnalyticsWidget(models.Model):
    ...
    data_source = models.CharField(max_length=100)  # e.g., 'products.sales', 'rides.completed'
...
class UserAnalytics(models.Model):
    ...
    data_type = models.CharField(max_length=50)  # e.g., 'dashboard_view', 'widget_interaction'
    data = models.JSONField()
...
class AnalyticsReport(models.Model):
    ...
    data = models.JSONField()
    file_path = models.CharField(max_length=500, blank=True)  # For PDF/Excel exports
    created_at = models.DateTimeField(auto_now_add=True)
